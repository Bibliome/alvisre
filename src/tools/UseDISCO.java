...
public class UseDISCO {
    ...
    public static void main(String[] args) throws IOException{
        ...
        // second argument is the io.input word
        String word = args[1];
	 ...
	 ****************************************/
        ...
        // retrieve the frequency of the io.input word
        ...
        // retrieve the collocations for the io.input word
        ...
        // retrieve the most similar words for the io.input word
        ...
        // compute second order similarity between the io.input word and its most
        // similar words
	System.out.println("Computing second order similarity between "+word+
			   " and all of its similar words...");
	long startTime = System.currentTimeMillis();
        for(int i = 1; i < simResult.words.length; i++){
	    disco.secondOrderSimilarity(word, simResult.words[i]);
	}
	...
	startTime = System.currentTimeMillis();
        for(int i = 1; i < simResult.words.length; i++){
	    discoRAM.secondOrderSimilarity(word, simResult.words[i]);
	}
	endTime = System.currentTimeMillis();
